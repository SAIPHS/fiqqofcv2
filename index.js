...
nopref = false
prefa = '.'
bacaanmenu ='root@FiqqBotz~#' //BUAT FOOTER MENU, GANTI KALO MAU
...
const katalog = (teks) => {
             res = conn.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Fiqq_*", "thumbnail": imgmenu, "surface": 'CATALOG' }}, {quoted:fkontak})
...
${x} Uptime : ${waktu(ruan)}
${x} Script : https://bit.ly/escebotnya
${x} Group Bot : https://bit.ly/gcbotfiqq
`
...
buttonsMessage = {footerText:'© Fiqq', imageMessage: imageMsg,
